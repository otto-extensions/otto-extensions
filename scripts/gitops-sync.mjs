...
const repositories = [
  ...
  { name: "otto-data-extension", localPath: path.join(workspaceRoot, "otto-data-extension") },
...
const requiredFiles = [
  ...
  "otto-data-extension/manifests/extension.json",
  "otto-data-extension/src/data-core.ts",
  "otto-data-extension/src/data-config.ts",
  "otto-data-extension/src/data-rescan.ts",
  "otto-data-extension/src/database-integration.ts",
